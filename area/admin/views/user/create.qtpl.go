...
//line admin\views\user\create.qtpl:1
package user
...
//line admin\views\user\create.qtpl:2
import (
	"fasthttpweb/area"
)

//line admin\views\user\create.qtpl:7
var (
	_ = qtio422016.Copy
	_ = qt422016.AcquireByteBuffer
)

//line admin\views\user\create.qtpl:8
type CreatePage struct {
	*area.BasePage
}

//line admin\views\user\create.qtpl:13
...
//line admin\views\user\create.qtpl:14
...
//line admin\views\user\create.qtpl:16
...
//line admin\views\user\create.qtpl:18
...
//line admin\views\user\create.qtpl:20
func (p *CreatePage) StreamRenderBody(qw422016 *qt422016.Writer) {
	//line admin\views\user\create.qtpl:20
	qw422016.N().S(`
	<div class="text-center">
		<form class="form-horizontal" action="`)
	//line admin\views\user\create.qtpl:22
...
`)
//line admin\views\user\create.qtpl:48
}
